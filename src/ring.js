(function ($) {
     ...
     */
    function drawSector(canvas, pointX, pointY, startAngle, endAngle, radius, isFill, color, anticlockwise) {
        ...
        if (canvas.getContext) {
            ...
            ctx.beginPath();
            //画出弧线
            ctx.arc(centerPoint.x, centerPoint.y, radius, startAngle, endAngle, anticlockwise);
            //画出结束半径
